...
ActiveRecord::Schema.define(version: 2020_03_14_065932) do
...
#   Mysql2::Error::ConnectionError: Lost connection to MySQL server during query: SHOW CREATE TABLE `users`
